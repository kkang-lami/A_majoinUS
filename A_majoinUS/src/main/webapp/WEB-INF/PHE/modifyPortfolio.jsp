			...
			<section class="content-header">
				...
				<div class="box box-danger">
					<div class="box-header with-border">
						<form class="form-horizontal" method="post" enctype="multipart/form-data" action="modifyPortfolio" name="myportfolio">
							<div class="box-body">
								<div class="form-group">
				                	<label for="subject" class="col-sm-1 control-label">제 목</label>
				                	<div class="col-sm-11">
				                		<input type="text" class="form-control" id="subject" name="subject" value="${port.subject}">
				                	</div>
				                </div>
								...
								<div class="form-group">
				                	...
				                	<div class="col-sm-5">
				                		<input type="text" class="form-control" id="tech_info" name="tech_info" value="${port.tech_info}">
				                	</div>
				                ...
				                <div id="portfolio">     	             
                       			...
                       			<div class="form-group">
                       				...
                       				<!--  -->
                       				<input type="text" value="<%=request.getContextPath()%>/aus/PHE/getImg/a.PNG" />
                       				<img src="<%=request.getContextPath()%>/aus/PHE/getImg/a.PNG" />
									<c:forEach items="${port_d}" var="port_d">
										
										<input type="text" value="${port_d.pd_img}">
										<textarea >${port_d.pd_content}</textarea>
									</c:forEach>
