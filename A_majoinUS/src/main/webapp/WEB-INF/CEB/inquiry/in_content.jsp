		...
		<table class="table">
			...
			<div class="box box-default">
				<div class="box-header with-border">
					<h4>질의 하시기 전에<a href="aus/notice">공지사항</a>과, <a href="aus/qna">F&Q</a>에서 먼저 찾아주세요.</h4>
				</div>
			</div>
		</table>
...
<%-- 	<c:if test="${!empty sessionScope.id}">
	  ...
	  <input type="button" value="글수정" class="btn btn-warning pull-left" 
	   class="btn btn-primary"  onclick="document.location.href='in_update?num=${inquiry.i_num}'" >
	   &nbsp;&nbsp;&nbsp;&nbsp;
